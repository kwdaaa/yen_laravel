    ...
    <div class="contents">
        ...
        <div class="person">
            ...
            <table class="person_record">
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->both_food_total }}</a></td>
                </tr>
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->both_daily_total }}</a></td>
                </tr>
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->both_leisure_total }}</a></td>
                </tr>
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->both_housing_total }}</a></td>
                </tr>
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->both_other_total }}</a></td>
                </tr>
            </table>
        ...
        <div class="person">
            ...
            <table class="person_record">
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->person1_food_total }}</a></td>
                </tr>
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->person1_daily_total }}</a></td>
                </tr>
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->person1_leisure_total }}</a></td>
                </tr>
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->person1_housing_total }}</a></td>
                </tr>
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->person1_other_total }}</a></td>
                </tr>
            </table>
        ...
        <div class="person">
            ...
            <table class="person_record">
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->person2_food_total }}</a></td>
                </tr>
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->person2_daily_total }}</a></td>
                </tr>
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->person2_leisure_total }}</a></td>
                </tr>
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->person2_housing_total }}</a></td>
                </tr>
                <tr>
                    <td class="date" ><a href="/">¥{{ $couple->total->person2_other_total }}</a></td>
                </tr>
            </table>
